...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference("Column.count") do
      post columns_url, params: { column: { code: @column.code, name: @column.name, table_id: @column.table_id, type: @column.type } }
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { code: @column.code, name: @column.name, table_id: @column.table_id, type: @column.type } }
